...
export type ResolutionContext = Pick<MetroResolutionContext, "extraNodeModules" | "originModulePath">;
export type ModuleResolver = (context: ResolutionContext, moduleName: string, platform: string) => string;

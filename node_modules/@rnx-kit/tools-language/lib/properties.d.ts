 ...
 */
export declare function pickValue<T>(obj: T, key: keyof T, name?: string): {
    [name: string]: unknown;
} | undefined;
/**
 ...
 */
export declare function extendObject<T extends Record<string, unknown>, TExtended extends T>(obj: T, extendedProps: Omit<TExtended, keyof T>): TExtended;
/**
 ...
 */
export declare function extendObjectArray<T extends Record<string, unknown>, TExtended extends T>(arr: T[], extendedProps: Omit<TExtended, keyof T>): TExtended[];
/**
 ...
 */
export declare function hasProperty<Property extends string>(obj: unknown, property: Property): obj is Record<Property, unknown>;
/**
 ...
 */
export declare function keysOf<T extends Record<string, unknown>>(obj: T | undefined): (keyof T)[];

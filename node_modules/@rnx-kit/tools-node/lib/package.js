...
function findPackageDependencyDir(ref, options) {
    ...
    const packageDir = find_up_1.default.sync(path.join("node_modules", pkgName), {
        ...(0, properties_1.pickValues)(options !== null && options !== void 0 ? options : {}, ["startDir", "allowSymlinks"], ["cwd", "allowSymlinks"]),
        type: "directory",
    });
